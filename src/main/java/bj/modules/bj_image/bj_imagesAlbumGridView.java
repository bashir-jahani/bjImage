...
public class bj_imagesAlbumGridView extends Fragment {
    public bj_imagesAlbumGridView(ArrayList<bj_image.GImageNotice> ImagePaths, Boolean CanAdd, Boolean CanDel){
        imagePaths=ImagePaths;
        this.CanAdd=CanAdd;
        this.CanDel=CanDel;
    }
    public bj_imagesAlbumGridView(String DirectoryPath, @Nullable List<String> FILE_EXTN, Boolean CanAdd, Boolean CanDel){
    ...
    private ArrayList<bj_image.GImageNotice> imagePaths ;
...
Boolean CanAdd,CanDel;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.g_images_album_gridview, container, false);
